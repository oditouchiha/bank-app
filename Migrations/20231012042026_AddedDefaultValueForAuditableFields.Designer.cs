...
namespace BankApp.Migrations
{
    ...
    [Migration("20231012042026_AddedDefaultValueForAuditableFields")]
    partial class AddedDefaultValueForAuditableFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankApp.Models.AccountPortofolio", b =>
                {
                    b.Property<int>("AccountId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AccountId", "PortofolioId");

                    b.HasIndex("PortofolioId");

                    b.ToTable("AccountsPortofolios");
                });
            ...
            modelBuilder.Entity("BankApp.Models.Portofolio", b =>
                {
                    b.Property<int>("PortofolioId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BankApp.Models.AccountPortofolio", b =>
                {
                    b.HasOne("BankApp.Models.Account", "Account")
                        .WithMany("AccountPortofolios")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BankApp.Models.Portofolio", "Portofolio")
                        .WithMany("AccountPortofolios")
            ...
            modelBuilder.Entity("BankApp.Models.Account", b =>
                {
                    b.Navigation("AccountPortofolios");
